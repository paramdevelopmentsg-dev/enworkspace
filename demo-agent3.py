...
concierge_agent=Agent(name="concierge_agent",instructions=instruction,model=gemini_model,output_type=TravelPlanner)
with trace("Concierge Agent Trace"):
    ...
    print(second_response.final_output.travelInfo)

# output in the format of TravelPlanner object and finally in JSON format 
